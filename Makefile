...
build-rest-api-svc: ## Builds the rest-api-svc binary locally into ./dist
	$(GOENVVARS) go build -ldflags "all=$(LDFLAGS)" -o ./services/rest-api-svc/dist/rest-api-svc ./services/rest-api-svc/cmd

.PHONY: build-account-svc
build-account-svc: ## Builds the account-svc binary locally into ./dist
	$(GOENVVARS) go build -ldflags "all=$(LDFLAGS)" -o ./services/account-svc/dist/account-svc ./services/account-svc/cmd
